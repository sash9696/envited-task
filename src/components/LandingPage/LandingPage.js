	...
	return (
		<div className="landing_page_container">
			...
			<div className="landing_page_right_section">
				<p className="landing_page_right_title_one">{LANDING_PAGE_TEXTS.MAIN_TEXT_LINE1}</p>
				<p className="landing_page_right_title_two">{LANDING_PAGE_TEXTS.MAIN_TEXT_LINE2}</p>
				<p className="landing_page_right_title_three">{LANDING_PAGE_TEXTS.MAIN_TEXT_LINE3}</p>
				<p className="landing_page_right_description">
					{LANDING_PAGE_TEXTS.SUB_TEXT}
				</p>
				<div className="landing_page_right_button_container">
						<button onClick={goToCreateEventPage} className="landing_page_right_button">
